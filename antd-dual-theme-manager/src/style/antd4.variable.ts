...
.ant-btn-group > .ant-btn-sm:first-child:not(:last-child),
.ant-btn-group > span:first-child:not(:last-child) > .ant-btn-sm {
  border-top-left-radius: var(--ant-border-radius-sm);
  border-bottom-left-radius: var(--ant-border-radius-sm);
}
.ant-btn-group-sm > .ant-btn:last-child:not(:first-child),
.ant-btn-group-sm > span:last-child:not(:first-child) > .ant-btn
.ant-btn-group > .ant-btn-sm:last-child:not(:first-child),
.ant-btn-group > span:last-child:not(:first-child) > .ant-btn-sm {
  border-top-right-radius: var(--ant-border-radius-sm);
  border-bottom-right-radius: var(--ant-border-radius-sm);
}
.ant-btn-group-lg > .ant-btn:first-child:not(:last-child),
.ant-btn-group-lg > span:first-child:not(:last-child) > .ant-btn,
.ant-btn-group > .ant-btn-lg:first-child:not(:last-child),
.ant-btn-group > span:first-child:not(:last-child) > .ant-btn-lg {
...
.ant-btn-group-lg > span:last-child:not(:first-child) > .ant-btn
.ant-btn-group > .ant-btn-lg:last-child:not(:first-child),
.ant-btn-group > span:last-child:not(:first-child) > .ant-btn-lg {
...
.ant-btn-group-rtl.ant-btn-group-sm > span:last-child:not(:first-child) > .ant-btn {
  border-radius: var(--ant-border-radius-sm) 0 0 var(--ant-border-radius-sm);
}
.ant-btn:focus > span,
.ant-btn:active > span {
  position: relative;
...
.ant-tabs-card.ant-tabs-right > div > .ant-tabs-nav .ant-tabs-tab + .ant-tabs-tab {
  margin-top: var(--ant-border-radius);
}
...
.ant-input-group-lg.ant-input-group-compact > *:first-child,
.ant-input-group-lg.ant-input-group-compact > .ant-select:first-child > .ant-select-selector,
.ant-input-group-lg.ant-input-group-compact > .ant-select-auto-complete:first-child .ant-input,
.ant-input-group-lg.ant-input-group-compact > .ant-cascader-picker:first-child .ant-input {
  border-top-left-radius: var(--ant-border-radius-lg);
  border-bottom-left-radius: var(--ant-border-radius-lg);
}
.ant-input-group-sm.ant-input-group-compact > *:first-child,
.ant-input-group-sm.ant-input-group-compact > .ant-select:first-child > .ant-select-selector,
.ant-input-group-sm.ant-input-group-compact > .ant-select-auto-complete:first-child .ant-input,
.ant-input-group-sm.ant-input-group-compact > .ant-cascader-picker:first-child .ant-input {
  border-top-left-radius: var(--ant-border-radius-sm);
  border-bottom-left-radius: var(--ant-border-radius-sm);
}
...
.ant-input-group-lg.ant-input-group-compact > *:last-child,
.ant-input-group-lg.ant-input-group-compact > .ant-select:last-child > .ant-select-selector,
.ant-input-group-lg.ant-input-group-compact > .ant-cascader-picker:last-child .ant-input,
.ant-input-group-lg.ant-input-group-compact > .ant-cascader-picker-focused:last-child .ant-input {
  border-top-right-radius: var(--ant-border-radius-lg);
  border-bottom-right-radius: var(--ant-border-radius-lg);
}
.ant-input-group-sm.ant-input-group-compact > *:last-child,
.ant-input-group-sm.ant-input-group-compact > .ant-select:last-child > .ant-select-selector,
.ant-input-group-sm.ant-input-group-compact > .ant-cascader-picker:last-child .ant-input,
.ant-input-group-sm.ant-input-group-compact > .ant-cascader-picker-focused:last-child .ant-input {
  border-top-right-radius: var(--ant-border-radius-sm);
  border-bottom-right-radius: var(--ant-border-radius-sm);
}
.ant-input-group.ant-input-group-compact > .ant-select-auto-complete .ant-input {
...
.ant-input-group-lg.ant-input-group-compact .ant-input-group-wrapper:not(:last-child).ant-input-search > .ant-input-group > .ant-input {
  border-radius: var(--ant-border-radius-lg) 0 0 var(--ant-border-radius-lg);
}
.ant-input-group-sm.ant-input-group-compact .ant-input-group-wrapper:not(:last-child).ant-input-search > .ant-input-group > .ant-input {
  border-radius: var(--ant-border-radius-sm) 0 0 var(--ant-border-radius-sm);
}
...
.ant-input-search-large > .ant-input-group > .ant-input-group-addon:last-child .ant-input-search-button {
  border-radius: 0 var(--ant-border-radius-lg) var(--ant-border-radius-lg) 0;
}
.ant-input-search-small > .ant-input-group > .ant-input-group-addon:last-child .ant-input-search-button {
  border-radius: 0 var(--ant-border-radius-sm) var(--ant-border-radius-sm) 0;
}
